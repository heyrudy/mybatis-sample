...
import com.heyrudy.mybatissample.api.controller.CityController;
...
class CityEntityControllerWebLayerTest {
    ...
    void createCity() throws Exception {
        ...
        willDoNothing().given(restService).createCity(any(CityEntity.class));
    ...
    void findCities() throws Exception {
        ...
        List<CityEntity> citiesDto = List.of();
    ...
    void findCityById() throws Exception {
        ...
        given(restService.findCityById(isA(CityCriteriaDTO.class))).willReturn(Option.of(cityEntity));
