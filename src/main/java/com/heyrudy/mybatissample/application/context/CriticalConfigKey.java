...
import com.heyrudy.mybatissample.application.context.CriticalConfigKey.CriticalPostgresDSLContextConfigKey;
import com.heyrudy.mybatissample.domain.MissingCriticalConfigError;
import com.heyrudy.mybatissample.domain.MissingCriticalConfigError.CriticalDSLContextNotFoundByDependencyLocatorError.ErrorMessage;
...
public sealed interface CriticalConfigKey<T>
    extends ConfigKey<T>
    permits CriticalPostgresDSLContextConfigKey,
    CriticalH2DSLContextConfigKey {
