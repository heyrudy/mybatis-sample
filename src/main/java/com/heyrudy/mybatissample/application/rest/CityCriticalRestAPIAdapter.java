...
public enum CityCriticalRestAPIAdapter {
    ...
    private static final CityValidatorModule.CityRequestDTOValidator CITY_REQUEST_DTO_VALIDATOR = CityRequestDTOValidator.INSTANCE;
    private static final CityValidatorModule.CityCriteriaValidator CITY_CRITERIA_VALIDATOR = CityCriteriaValidator.INSTANCE;
